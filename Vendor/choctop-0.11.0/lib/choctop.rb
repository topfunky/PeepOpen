...
class ChocTop
  ...
  def initialize
    ...
    @version ||= expand_env_var(info_plist['CFBundleVersion'])
  ...
  ##
  # Turn ${MY_APP_VERSION} into the value set in the environment.
  #
  # Returns: The interpolated value, or the original value if no
